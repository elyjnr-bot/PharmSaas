  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'float': '0 4px 20px rgba(83, 125, 20, 0.32), 0 2px 6px rgba(0,0,0,0.08)',
        'nav': '0 -1px 0 rgba(0,0,0,0.06)',
        'emerald': '0 4px 16px rgba(83,125,20,0.28)',
      },
      ...
      colors: {
        // ── Palette lime-vert JunglePharm (dérivée du logo) ─────────────────────
        // Utilisée pour jungle-* ET emerald-* (override) → cohérence totale.
        jungle: {
          50:  '#f7fce8',
          100: '#eef7cc',
          200: '#d8ed96',
          300: '#bcd96e',   // logo stop clair
          400: '#aad44c',
          500: '#96c244',   // logo stop milieu (couleur principale)
          600: '#537d14',   // logo stop foncé (texte sur fond clair)
          700: '#5a8520',
          800: '#3d5c14',
          900: '#2a4009',
          950: '#1a2b04',
